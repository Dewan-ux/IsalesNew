...
<head>
  ...
  <title>Khalifah Asia | Register</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset ('adminlte-v2/') }}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <img src="{{ asset('adminlte-v2/dist/img/logo.png') }}" alt="logo-ka" class="img-responsive logo">
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{ asset ('adminlte-v2/') }}/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
